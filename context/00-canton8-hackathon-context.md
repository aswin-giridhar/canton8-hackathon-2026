...
Credentials live in `/mnt/e/Hackathon/canton8_hackathon_2026/.env`, outside the
toolkit repo so they cannot be committed upstream. **`/mnt/e` is a DrvFs mount and
...
exit 0     build ~19s, test ~19s (on the /mnt/e Windows mount)
```
